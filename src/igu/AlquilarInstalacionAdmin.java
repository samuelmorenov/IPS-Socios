...
public class AlquilarInstalacionAdmin extends JDialog {
	...
	public AlquilarInstalacionAdmin() {
		setModal(true);
		...
		if (btnAlquilar == null) {
			...
			btnAlquilar.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					fechaInicio = fechaInicio.minusHours(fechaInicio.getHourOfDay()-1);
					...
					fechaInicio = fechaInicio.plusHours(Integer.parseInt(getCbHoraInicio().getSelectedItem().toString()));
					DateTime fechaFinal;
					...
					try {
						if (DatabaseLogic.comprobarInstalacionLibre(fechaInicio, fechaFinal,
							...
							if (DatabaseLogic.comprobarSocioSinAlquiler(fechaInicio, fechaFinal, alquiler.id_socio)) {
								...
								BufferedWriter bw = new BufferedWriter(new FileWriter("ConflictosAlquiler.txt"));
								bw.write("Conflicto: Socio con reserva simultanea\n");
								bw.write("Socio: "+alquiler.id_socio+"\n");
